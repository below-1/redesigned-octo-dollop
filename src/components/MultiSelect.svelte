<script>
  ...
  onMount(() => {
    createPopper(trigger, select_element, {})
  })
</script>

<div 
  class="flex flex-wrap items-center rounded border-2 border-gray-200 p-1"
>
  <button 
    bind:this={trigger}
...
<div bind:this={select_element} class="flex flex-col bg-white" class:hidden="{ !show_select }">
